...
public abstract class ListenableAsyncTask<Params, Progress, Result> extends
		AsyncTask<Params, Progress, Result> {

	/**
	 * Our completion and progress listener. This is the thing that we'll call
	 * when things get completed.
	 * 
	 * @author bjdupuis
	 * 
	 * @param <Progress>
	 ...
	 * 
	 * @param the
	 *            base <code>Activity</code> that the listener runs on
	 * @param listener
	 *            the listener to register.
	 */
	public ListenableAsyncTask(Activity activity,
			OnCompleteListener<Progress, Result> listener) {
		this();
	...
	/**
	 * Register a listener to be notified when the task completes and updates
	 * progress.
	 * 
	 * @param listener
	...
	/**
	 * Unregister the registered listener. If it's desirable for more than one
	 * listener to be notified, it's trivial to have a list of listeners.
	 */
